<?php 
    ...
    /*
    * This class processes the ingredients to get the highest recipe score.
    */
    class ProcessIngredients {
        ...
        function get_teaspoon_combinations($targetSum, $numIntegers, $memo = []){
            ...
            for ($i = 1; $i <= $targetSum; $i++) {
                ...
                $subCombinations = $this->get_teaspoon_combinations($targetSum - $i, $numIntegers - 1, $memo);
        ...
        function process_data_to_get_highest_recipe_score($ingredients, $total_ingredients, $teaspoon_combinations, $max_allowed_calories) {
            ...
            $return_data = array(
                ...
                "calories" => $temp_calories, "capacity" => $temp_capacity, 
                "durability" => $temp_durability, "flavor" => $temp_flavor, 
